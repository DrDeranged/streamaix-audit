  ...
  app.get("/api/push/subscriptions", authenticateToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    res.json({ 
      ...
      subscriptions: subscriptions.map((sub) => {
        ...
        morningBriefing: sub.morningBriefing,
        eveningRecap: sub.eveningRecap,
        marketMovers: sub.marketMovers,
        macroAlerts: sub.macroAlerts,
        breakingNews: sub.breakingNews,
        coinDeskNews: sub.coindeskNews,
        fundingRateAlerts: sub.fundingRateAlerts,
        liquidationAlerts: sub.liquidationAlerts,
        whaleAlerts: sub.whaleAlerts,
        volumeSpikes: sub.volumeSpikes,
        weeklyPreview: sub.weeklyPreview,
        streamLive: sub.streamLive,
        streamTips: sub.streamTips,
        streamMilestones: sub.streamMilestones,
        streamReminders: sub.streamReminders,
