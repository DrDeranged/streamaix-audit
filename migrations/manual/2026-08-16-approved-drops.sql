...
CREATE TABLE IF NOT EXISTS ai_trading_setups_drift_backup_20260816 AS
...
CREATE TABLE IF NOT EXISTS bounties_drift_backup_20260816 AS
...
CREATE TABLE IF NOT EXISTS stream_recordings_drift_backup_20260816 AS
...
CREATE TABLE IF NOT EXISTS avatar_insights_drift_backup_20260816 AS
...
CREATE TABLE IF NOT EXISTS scheduled_debates_drift_backup_20260816 AS
...
CREATE TABLE IF NOT EXISTS stream_predictions_drift_backup_20260816 AS
...
CREATE TABLE IF NOT EXISTS achievement_definitions_drift_backup_20260816 AS
