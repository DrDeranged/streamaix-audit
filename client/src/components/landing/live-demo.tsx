              ...
              <CardContent className="p-8">
                {activeView === "raw" && (
                  <div>
                    ...
                    <div className="bg-muted rounded-lg p-6 mb-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-4">
                          <Button 
                            size="icon" 
                            className="bg-indigo-500 rounded-full hover:bg-indigo-600"
                        ...
                        <div className="text-right">
                          <div className="text-sm font-medium text-foreground">Processing: {progress}% complete</div>
                      ...
                      {/* Enhanced Waveform */}
                      <div className="mb-4">
                        <div className="flex items-end space-x-1 h-24 opacity-60 mb-2">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 mb-6">
                      <div className="glass-bg glass-border rounded-lg p-4 text-center">
                        <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-2">
                          <CheckCircle className="w-5 h-5 text-white" />
                        </div>
                        <div className="text-sm font-medium">Audio Extraction</div>
                    ...
                    <div className="text-center text-muted-foreground">
                      <div className="flex items-center justify-center space-x-2 mb-2">
                        ...
                        <span className="font-medium">Whisper AI is analyzing the audio content...</span>
                      </div>
                      <p className="text-sm">This usually takes 2-3 minutes for a 2-hour podcast</p>
                    </div>
                  </div>
                )}
                ...
                {activeView === "transcript" && (
                  <div>
                    ...
                    <div className="max-h-96 overflow-y-auto space-y-6 text-muted-foreground">
                      <div className="flex space-x-4 p-4 bg-muted rounded-lg hover:bg-muted/80 transition-colors">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            <span className="text-indigo-500 font-medium text-sm">[00:45:23]</span>
