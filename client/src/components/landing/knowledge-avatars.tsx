    ...
    <section id="profiles" className="py-20 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-5xl md:text-6xl font-orbitron font-bold mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-700 bg-clip-text text-transparent">
            Alpha Network
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
