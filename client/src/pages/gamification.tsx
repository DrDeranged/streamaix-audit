          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              {level.prestigeLevel > 0 && (
                <div className="absolute -top-1 -right-1 w-5 h-5 rounded-xl bg-warn flex items-center justify-center border border-amber-300">
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  streak.currentStreak > 0 && "border-warn/30 bg-orange-500/5"
                )}
              >
