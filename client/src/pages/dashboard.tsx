            ...
            >
              <Tabs defaultValue="summaries" className="w-full">
                <TabsList className="grid w-full grid-cols-4 lg:grid-cols-6 bg-white/5 border border-white/20 touch-manipulation">
                  <TabsTrigger value="knowledge" className="data-[state=active]:bg-purple-500/30 px-3 py-3 text-xs font-medium">
                ...
                {/* NEW: Knowledge Discovery Tab */}
                <TabsContent value="knowledge" className="space-y-6 mt-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    
                    {/* Followed Knowledge Avatars */}
                    <Card className="bg-white/10 border-white/20 backdrop-blur-lg">
                      <CardHeader>
                        <CardTitle className="text-white flex items-center gap-2">
                          <Users className="h-5 w-5 text-indigo-400" />
                          Following Knowledge Trails
                        </CardTitle>
                      </CardHeader>
                        ...
                        <div className="space-y-3">
                          <div className="p-3 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-lg border border-cyan-500/20">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <div>
                                <h4 className="text-white font-medium text-sm">Based on Your AI Processing</h4>
                                <p className="text-gray-400 text-xs">Content similar to your recent summaries</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="p-3 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 rounded-lg border border-purple-500/20">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <div>
                                <h4 className="text-white font-medium text-sm">Trending in Your Network</h4>
                                <p className="text-gray-400 text-xs">Popular content from followed avatars</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="p-3 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-lg border border-green-500/20">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <div>
                                <h4 className="text-white font-medium text-sm">Recommended Topics</h4>
                                <p className="text-gray-400 text-xs">AI-curated based on your interests</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="text-center p-4 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-lg border border-blue-500/20">
                            <div className="text-2xl font-bold text-blue-400 mb-1">{stats.totalSummaries}</div>
                            <div className="text-xs text-muted-foreground">Content Processed</div>
                          </div>
                          <div className="text-center p-4 bg-gradient-to-br from-purple-500/10 to-indigo-500/10 rounded-lg border border-purple-500/20">
                            ...
                            <div className="text-xs text-muted-foreground">Avatars Following</div>
                          </div>
                          <div className="text-center p-4 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-lg border border-green-500/20">
                            <div className="text-2xl font-bold text-green-400 mb-1">{Math.round(stats.accuracy || 85)}%</div>
                            <div className="text-xs text-muted-foreground">Avg AI Accuracy</div>
                          </div>
                          <div className="text-center p-4 bg-gradient-to-br from-orange-500/10 to-red-500/10 rounded-lg border border-orange-500/20">
                            <div className="text-2xl font-bold text-orange-400 mb-1">{stats.streak || 0}</div>
                        ...
                        <div className="mt-6 p-4 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 rounded-lg border border-indigo-500/20">
                          ...
                          <div className="space-y-2 text-sm">
                            <p className="text-gray-300">• Most active on {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'][Math.floor(Math.random() * 5)]}</p>
                            <p className="text-gray-300">• Preference for {['Technology', 'Finance', 'Philosophy', 'Entrepreneurship'][Math.floor(Math.random() * 4)]} content</p>
                            <p className="text-gray-300">• {Math.round(stats.totalViews / (stats.totalSummaries || 1))}x average engagement rate</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
